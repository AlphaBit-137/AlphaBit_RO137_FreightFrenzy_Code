...
public class OnlyCaruselRed extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Vector2d vector = new Vector2d(-15,-40);
        Vector2d vectori = new Vector2d(-15,-45);
        Vector2d vectorii = new Vector2d(-15,-50);
        Vector2d vector2 = new Vector2d(-59,-35);

        Pose2d pose;
        waitForStart();
        Trajectory spline1caz1 =drivetrain.trajectoryBuilder(new Pose2d(-35,-60,Math.toRadians(-90)))
        ...
        Trajectory spline2 = drivetrain.trajectoryBuilder(spline1caz1.end())
                ...
                .build();
        Trajectory GoForward = drivetrain.trajectoryBuilder(new Pose2d(-59,-60,0))
                .forward(20)
                .build();
